...
public final class CustomCape extends Module {
    ...
    public static void loadCapes() {
        ...
        for (String s : builtinCapes) {
            ...
            try {
                InputStream stream = Raven.class.getResourceAsStream("/assets/minecraft/keystrokesmod/textures/capes/" + name + ".png");
                if (stream == null)
                    stream = Raven.class.getResourceAsStream("/assets/minecraft/keystrokesmod/textures/capes/" + s + ".png");
                if (stream == null)
                    continue;
