...
public class PredictEngine extends EntityPlayer implements Cloneable {
    ...
    public void sync() {
        ...
        this.newPosX = player.fabricPlayer.newPosX;
        this.newPosY = player.fabricPlayer.newPosY;
        this.newPosZ = player.fabricPlayer.newPosZ;
        this.rotationYaw = player.fabricPlayer.rotationYaw;
        this.rotationPitch = player.fabricPlayer.rotationPitch;
        this.newRotationYaw = player.fabricPlayer.newRotationYaw;
        this.newRotationPitch = player.fabricPlayer.newRotationPitch;
        this.newPosRotationIncrements = player.fabricPlayer.newPosRotationIncrements;
        ...
        this.dead = player.fabricPlayer.isDead;
        ...
        this.activePotionsMap = (player.fabricPlayer.activePotionsMap);
    }
        ...
        if (this.getItemInUse() != null) {
            ...
            if (itemstack == this.getItemInUse()) {
                if (this.getItemInUseCount() <= 0) {
                    ...
                    this.itemInUseCount = (this.getItemInUseCount() - 1);
